...
const Sponsors = () => {
  return (
    <div id="sponsors">
      <div className="flex justify-center items-center bg-[#000A0C] text-white">
        <div className="flex flex-col justify-center text-center items-center py-8 w-[100%] md:w-[80%]">
              ...
              <div className=" grid md:grid-cols-3  place-items-center space-y-8 md:space-y-0">
                <div className="w-[70%] px-4 md:w-[70%] logo">
                  <a href="https://dare2compete.com/" target="_blank">
                    <img
                      src="https://i.ibb.co/0XWx9N2/d2c-white-color2.png"
                      alt="Dare2Compete"
                    />
                  </a>
                </div>
