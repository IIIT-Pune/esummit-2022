...
const CapCard = (props) => {
  ...
  return (
    <div className="flex flex-col items-center  pt-6 lg:w-fit">
      <div className="w-[90%] justify-center items-center flex">
        <div className="border border-sky-500 bg-black space-y-5 lg:space-y-10 w-full lg:w-4/5 flex flex-col justify-center items-center">
          <div className="font-Montserrat text-2xl text-white font-bold mt-4 lg:my-2 lg:mt-8">
          ...
          <div>
            <div className="font-Poppins text-white font-bold grid grid-cols-2 gap-32 lg:gap-12 content-center items-center justify-center ">
              <div>
                <div className="text-sky-500 text-center text-2xl">
                  #{props.rank}
                </div>
          ...
          <div className="hidden lg:inline-block">
            <img src="https://i.ibb.co/VWg6vG0/chatbot2.png" alt="" />
          </div>
        </div>
      </div>
    </div>
