  ...
  return (
    <div className="justify-center w-full md:w-1/2 bg-black text-sm md:py-2 items-center flex flex-col space-y-0 py-16">
      <div className="my-4 flex flex-col m-2 p-5 items-center ">
        ...
        <div>
          <button
            onClick={() => props.SetShowSignUp((prev) => !prev)}
            className="text-white font-Poppins border-2 hover:bg-white hover:text-black text-base font-semibold rounded-full m-2 p-2 px-7"
          >
